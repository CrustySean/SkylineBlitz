...
ensuredirectory(ftp, '/atmosphere/contents', "0100F8F0000A2000")
ensuredirectory(ftp, f'/atmosphere/contents/0100F8F0000A2000', 'exefs')

binaryPath = f'{os.path.basename(os.getcwd())}{version}.nso'
print(binaryPath)
if os.path.isfile(binaryPath):
    sdPath = f'/atmosphere/contents/0100F8F0000A2000/exefs/subsdk0'
    print(f'Sending {sdPath}')
    ftp.storbinary(f'STOR {sdPath}', open(binaryPath, 'rb'))

metaPath = f'cross.npdm'
sdPath = '/atmosphere/contents/0100F8F0000A2000/exefs/main.npdm'
print(f'Sending {sdPath}')
ftp.storbinary('STOR /atmosphere/contents/0100F8F0000A2000/exefs/main.npdm', open(metaPath, 'rb'))
